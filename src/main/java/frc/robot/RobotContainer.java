...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        // m_climb.setDefaultCommand(new TeleOp_Climb_Command(m_ballintake, m_climb, climb_options.STARTING));
    ...
    private void configureBindings() {
         ...
         * Climb
         */
        // driverXbox.pov(90).and(m_endevator.isAt(EndEvatorState.STOW)).onTrue(new TeleOp_Climb_Command(m_ballintake, m_climb, climb_options.DEPLOY));
        driverXbox.povUp().and(m_endevator.isAt(EndEvatorState.STOW)).onTrue(new TeleOp_Climb_Command(m_ballintake, m_climb, climb_options.DEPLOY));
        driverXbox.povDown().and(m_endevator.isAt(EndEvatorState.STOW)).onTrue(new TeleOp_Climb_Command(m_ballintake, m_climb, climb_options.CLIMB));
